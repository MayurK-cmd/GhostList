...
export class Contract {
      ...
      mint: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('mint',
                                     ...
                                     'allowlist_stub.compact line 86 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
  ...
  initialState(...args_0) {
    ...
    if (!(typeof(initialRoot_0) === 'bigint' && initialRoot_0 >= 0 && initialRoot_0 <= __compactRuntime.MAX_FIELD)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'allowlist_stub.compact line 71 char 1',
                                 'Field',
                                 initialRoot_0)
    }
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_15.toValue(0n),
                                                                                              alignment: _descriptor_15.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(initialRoot_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
  ...
  _secret_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('secret',
                                 'return value',
                                 'allowlist_stub.compact line 61 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _merklePath_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'object' && result_0.leaf.buffer instanceof ArrayBuffer && result_0.leaf.BYTES_PER_ELEMENT === 1 && result_0.leaf.length === 32 && Array.isArray(result_0.path) && result_0.path.length === 20 && result_0.path.every((t) => typeof(t) === 'object' && typeof(t.sibling) === 'object' && typeof(t.sibling.field) === 'bigint' && t.sibling.field >= 0 && t.sibling.field <= __compactRuntime.MAX_FIELD && typeof(t.goes_left) === 'boolean'))) {
      __compactRuntime.typeError('merklePath',
                                 'return value',
                                 'allowlist_stub.compact line 65 char 1',
  ...
  _mint_0(context, partialProofData) {
    const userSecret_0 = this._secret_0(context, partialProofData);
    const userPath_0 = this._merklePath_0(context, partialProofData);
    const leaf_0 = this._persistentHash_0(userSecret_0);
    __compactRuntime.assert(this._equal_0(leaf_0, userPath_0.leaf),
                            'Merkle path leaf does not match secret hash');
    const computedRoot_0 = this._merkleTreePathRoot_0(userPath_0);
    __compactRuntime.assert(computedRoot_0.field
                            ...
                            'Not on allowlist — invalid Merkle proof');
    const nullifier_0 = this._persistentHash_0(leaf_0);
    __compactRuntime.assert(!_descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       ...
                                                                                       [
                                                                                        ...
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                            'Already minted — nullifier already used');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'allowlist_stub.compact line 52 char 1',
                                     'Bytes<32>',
                                     elem_0)
        }
        return _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
...
const _dummyContract = new Contract({
  secret: (...args) => undefined, merklePath: (...args) => undefined
});
